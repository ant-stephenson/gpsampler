...
python $SCRIPT_DIR/rff/Sweep/multi_sweep_rff.py --job_id $SLURM_ARRAY_JOB_ID --param_idx=$SLURM_ARRAY_TASK_ID --verbose="True" --NO_TRIALS=1000 --significance_threshold=0.1 --ncpus=$SLURM_CPUS_PER_TASK --method=ciq --pre="False"
